...
// doTrafficLights() function 
function doTrafficLights() {
  const activeLight = getActiveLight();
  // your code will replace this call
  // to `console.log()`
  // if active light is red, then call turnRed()
  if(activeLight=='red'){
	  turnRed();
  }
  // else if active light is green,then call turnGreen()
  else if(activeLight=='green'){
	  turnGreen();
  }
  // else if active light is yellow, call turnYellow()
